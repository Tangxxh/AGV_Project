...
public:
    ...
    IMUPreintegration()
    {
        ...
        //added *****************************  by wzf
        //pubPoseinmap = nh.advertise<geometry_msgs::PoseStamped>("/global_pose",2000);
        //added *****************************  by wzf
    ...
    void imuHandler(const sensor_msgs::Imu::ConstPtr& imu_raw)
    {
        ...
        //publish pose in map ****************by wzf
        //poseinMap.header.frame_id = "map";
        //poseinMap.header.stamp = thisImu.header.stamp;

        //poseinOdom.header.stamp = thisImu.header.stamp;
        //poseinOdom.header.frame_id = "odom";
        //poseinOdom.pose = odometry.pose.pose;

        //try{
        //    listener.transformPose("map", poseinOdom, poseinMap);
        //}
        ...
        //    return;
        //}
        //pubPoseinmap.publish(poseinMap);
